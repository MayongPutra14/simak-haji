...
import { useUserManagement } from '../../../hooks/admin/user/useUserManagement';
...
import {
  ...
  getUserSession,
  deleteUserSession,
} from '../../../utils/admin/sessionStorage';
import {
...
const CreateUserFragment = () => {
  ...
  const handleStep2Submit = async (data) => {
    try {
      ...
      setCurrentStep(3);
      createUserSession(createdUserId, 3);
