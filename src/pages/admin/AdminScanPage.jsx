...
const AdminScanPage = () => {
  ...
  useEffect(() => {
    ...
    if (!eventId) {
      alert(
        'ID Event tidak ditemukan! Silakan buka scanner melalui Dashboard Admin.',
      );
      ...
      async (decodedText) => {
        ...
        try {
          const response = await axios.post(
            'http://localhost/simak_api/scan_absen.php',
            data,
          );
  ...
  return (
    <div className="p-8">
      ...
      <div
        id="reader"
        className="w-full max-w-md mx-auto rounded-lg overflow-hidden shadow-lg border-2 border-sea-green-600"
      ></div>
      {scanResult && (
